...
<p align="left"> Estudante de Análise e Desenvolvimento de Sistemas na Uniube, em transição para a área de tecnologia. Tenho experiência em projetos práticos envolvendo UX/UI, Front-End (HTML, CSS e JavaScript) e testes de qualidade (QA), o que me proporcionou uma visão mais completa do desenvolvimento de produtos digitais. Possuo facilidade de aprendizado, pensamento analítico e interesse em compreender problemas para construir soluções eficientes.
<br>
